...
const qualifiers = [
  {
    ...
    whimsyText: "Getting stuff done!",
  },
  {
    index: 1,
    whimsyClassName: "curious",
    whimsyText: "Who will I meet next?",
  },
  {
    index: 2,
    whimsyClassName: "openminded",
    whimsyText: "Learning from others",
  },
]
...
const initialQualifier = {
  index: null,
  whimsyClassName: "",
  whimsyText: "Teams I worked with",
}
...
const BoxJobs = () => (
  ...
  >
    ...
    >
      <ul>
        <li>
          A mature startup providing an SEO service to thousands of users daily
        </li>
        <li>
