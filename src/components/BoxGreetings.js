...
const qualifiers = [
  {
    ...
    whimsyText: "So happy you're here!",
  },
  {
    index: 1,
...
const BoxGreetings = () => (
  ...
  >
    <p>
      I am a <b>front-end</b> specialist. I love being part of cross-functional
      teams and being the <b>logical glue</b> between the back-end devs and the
      designers.
    </p>
    <p>
    ...
    <p>
      ...
      tech (Node, Go, SQL databases), and I'm delighted to dive into it when it
      is required!
    </p>
  </Box>
)
